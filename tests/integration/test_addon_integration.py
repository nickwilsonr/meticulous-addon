...
class TestConfigLoading(unittest.TestCase):
    ...
    @patch("builtins.open")
    @patch("os.getenv")
    def test_load_config_from_options_json(self, mock_getenv, mock_open):
        """Test loading config from /data/options.json."""
        # Mock environment (no supervisor token = no HTTP request)
    ...
    @patch("builtins.open")
    @patch("os.getenv")
    def test_load_config_defaults(self, mock_getenv, mock_open):
...
class TestRetryLogic(unittest.TestCase):
    ...
    @patch("builtins.open")
    @patch("os.getenv")
    def test_backoff_calculation_no_jitter(self, mock_getenv, mock_open):
    ...
    @patch("builtins.open")
    @patch("os.getenv")
    def test_backoff_calculation_with_jitter(self, mock_getenv, mock_open):
