...
class MeticulousAddon:
    ...
    async def publish_health_metrics(self) -> None:
        ...
        try:
            ...
            self.mqtt_client.publish(health_topic, jsonlib.dumps(health_data), qos=1, retain=True)
            msg = (
    ...
    async def _mqtt_publish_discovery(self) -> None:
        ...
        # Publish profiles manifest now that MQTT is live.
        # (May have been a no-op earlier if called before MQTT connected.)
    ...
    async def periodic_updates(self):
        ...
        while self.running:
            try:
                ...
                if time_since_last_stale_refresh >= self.stale_data_refresh_interval:
                    ...
                    # This ensures Home Assistant gets periodic refreshes of all sensor values
